...
or 0xFFFD by default. This is because post_net does not let you specify
your saddr in SOS.
...
class sossrv:
	"""
	Instantiate this class to connect to a SOS server.
	Optional arguments:
	  host, port - Location of SOS server
	  nid, pid   - Default did and daddr of posted messages
	  verbose    - True/False
	"""
	...
	def __init__(self, host=None, port=None, nid=0xFFFD, pid=128, verbose=False):
	...
	def post_net(self, did, sid, type, length, data, flags, daddr):
		...
		defaults to 0xFFFD, and sid (pid) defaults to 128.
