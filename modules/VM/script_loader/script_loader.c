...
static int8_t module(void *state, Message *msg)
{
    ...
    switch (msg->type){
        ...
        case MSG_INIT:
		{
			...
			//uint8_t script_buf[17] = { 0xA5,0x1,0x4,0x2,0xa,0x0,0x0,0x4,0x1f,0x65,0x4,0x1,0x20,0x1,0x80,0x11,0x0, };
			// timer1 no NOP
			//uint8_t script_buf[11] = { 0xA5,0x1,0x4,0x2,0x4,0x0,0x0,0x1,0x1a,0x3,0x0,  };
			// timer1 with NOP
			//uint8_t script_buf[12] = { 0xA5,0x1,0x4,0x2,0x5,0x0,0x0,0x1,0x1a,0x3,0x70,0x0, };
			// timer1 with get_data and bcast
			//uint8_t script_buf[20] = { 0xA5,0x1,0x4,0x2,0xd,0x0,0x0,0x1,0x1a,0x3,0x4,0x1f,0x65,0x24,0x1,0x20,0x1,0x80,0x11,0x0, };
			uint8_t script_buf[48] = { 0xA5,0x1,0x4,0x2,0x29,0x0,0x0,0x4,0x30,0xc,0x41,0x13,0x5,0x41,0x55,0x2,0x5,0x1f,0x66,0x24,0x41,0x55,0x4,0x1f,0x65,0x1,0x1f,0x4,0x2a,0x19,0x2,0x0,0x1,0x0,0x16,0x70,0x1,0x20,0x1,0x80,0x11,0x1,0x0,0x65,0x1,0x20,0x16,0x0, };
			// reboot context
			uint8_t script_buf2[11] = { 0xA5,0x0,0x0,0x0,0x4,0x0,0x0,0x1,0x20,0x16,0x0, };
			DEBUG("load_script\n");
		...
		case MSG_TIMER_TIMEOUT:
		{
			...
			/*
			uint8_t script_buf[17] = { 0xA5,0x1,0x4,0x2,0xa,0x0,0x0,0x4,0x1f,0x65,0x4,0x1,0x20,0x1,0x80,0x11,0x0, };
			uint8_t script_buf2[11] = { 0xA5,0x0,0x0,0x0,0x4,0x0,0x0,0x1,0x13,0x16,0x0, };
			DEBUG("load_script\n");
